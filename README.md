...
* **Focus:** Scalable ETL Architectures, Python/Pandas Data Processing, and Database Design.
...
**Note on Repository Quality:** These projects were primarily designed under **strict academic deadlines**. While they are fully functional and demonstrate the core logic and solution architecture, some of the underlying code is currently pending refactoring to meet production-level standards for documentation and modularity.

### 1. Large-Scale Data Pipeline: Movie Recommendation System
...
### 3. Image Preprocessing Pipeline: Fruit Quality Classification
